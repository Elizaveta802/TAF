...
public class SmokeTestHW {
        ...
        public void laminateCalculator() throws InterruptedException {
            ...
            WebElement resultNumberOfBoards = driver.findElement(By.cssSelector("[class='calc-result'] div:first-child"));
            Assert.assertEquals(resultNumberOfBoards.getText(), "Требуемое количество досок ламината: 53");

            WebElement resultNumberOfPackages = driver.findElement(By.cssSelector("[class='calc-result'] div:nth-child(2)"));
            Assert.assertEquals(resultNumberOfPackages.getText(), "Количество упаковок ламината: 7");
        }
